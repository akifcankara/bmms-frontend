...
export default function OwnershipStructureSection({
  errors,
  touched,
  values,
  setFieldValue,
}: OwnershipStructureSectionProps) {
  const isBranch = values.companySetupType === 'branch';
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-4">
            {COMPANY_SETUP_TYPES.map((type) => {
              ...
              const isSelected = values.companySetupType === type.value;
              return (
                <label
                  key={type.value}
        ...
        {isBranch && (
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-2">
              Branch Information <span className="text-red-500">*</span>
            </label>
            <p className="text-xs text-gray-500 mb-3">
              Please provide branch information below
            </p>
            ...
            <div className="mt-4">
              <label className="block text-sm font-semibold text-gray-700 mb-2">
                Upload of parent company documents{' '}
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center cursor-pointer hover:border-gray-400 transition-colors">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFieldValue('parentCompanyDocuments', e.target.files?.[0])
                  }
                />
              </div>
              <ErrorMessage
                name="parentCompanyDocuments"
                component="div"
                className="text-red-500 text-sm mt-1"
              />
            </div>
